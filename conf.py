...
BLOG_AUTHOR = "Test Author"  # (translatable)
BLOG_TITLE = "Test Site"  # (translatable)
...
BLOG_DESCRIPTION = "Test site for Nikola theming."  # (translatable)
...
# (translatable)
EXTRA_HEAD_DATA = """
    <link href="assets/css/sphinx-design.css" rel="stylesheet" type="text/css">
"""
